...
Adafruit_SGP30 * Adafruit_SGP30::sgp30_instance = nullptr;
Adafruit_SGP30 * Adafruit_SGP30::getInstance(){
    if(sgp30_instance == nullptr){
        sgp30_instance = new Adafruit_SGP30(PA_11,PA_12);
    }
    return sgp30_instance;
}
