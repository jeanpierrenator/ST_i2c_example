...
bool BME680::begin() {
    ...
    setHumidityOversampling(BME680_OS_1X);
    setPressureOversampling(BME680_OS_1X);
    setTemperatureOversampling(BME680_OS_1X);
 ...
 */
int8_t BME680::bme680_init(struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 * conditions.
 */
int8_t BME680::boundary_check(uint8_t *value, uint8_t min, uint8_t max, struct bme680_dev *dev)
{
 ...
 * null conditions.
 */
int8_t BME680::null_ptr_check(const struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 * of the sensor.
 */
int8_t BME680::bme680_set_regs(const uint8_t *reg_addr, const uint8_t *reg_data, uint8_t len, struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::bme680_soft_reset(struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::bme680_get_regs(uint8_t reg_addr, uint8_t *reg_data, uint16_t len, struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::set_mem_page(uint8_t reg_addr, struct bme680_dev *dev)
{
    int8_t rslt;
    uint8_t reg;
    uint8_t mem_page;
 ...
 */
int8_t BME680::get_mem_page(struct bme680_dev *dev)
{
    int8_t rslt;
    uint8_t reg;
 ...
 */
int8_t BME680::get_calib_data(struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::bme680_get_sensor_data(struct bme680_field_data *data, struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::read_field_data(struct bme680_field_data *data, struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int16_t BME680::calc_temperature(uint32_t temp_adc, struct bme680_dev *dev)
{
    int64_t var1;
    int64_t var2;
    int64_t var3;
 ...
 */
uint32_t BME680::calc_pressure(uint32_t pres_adc, const struct bme680_dev *dev)
{
    int32_t var1;
    int32_t var2;
    int32_t var3;
 ...
 */
uint32_t BME680::calc_humidity(uint16_t hum_adc, const struct bme680_dev *dev)
{
    int32_t var1;
    int32_t var2;
    int32_t var3;
 ...
 */
uint32_t BME680::calc_gas_resistance(uint16_t gas_res_adc, uint8_t gas_range, const struct bme680_dev *dev)
{
    int64_t var1;
    uint64_t var2;
    int64_t var3;
 ...
 */
void BME680::bme680_get_profile_dur(uint16_t *duration, const struct bme680_dev *dev)
{
 ...
 */
int8_t BME680::bme680_set_sensor_mode(struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
int8_t BME680::bme680_set_sensor_settings(uint16_t desired_settings, struct bme680_dev *dev)
{
    int8_t rslt;
    uint8_t reg_addr;
    uint8_t data = 0;
 ...
 */
int8_t BME680::set_gas_config(struct bme680_dev *dev)
{
    int8_t rslt;
 ...
 */
uint8_t BME680::calc_heater_res(uint16_t temp, const struct bme680_dev *dev)
{
    uint8_t heatr_res;
    int32_t var1;
    int32_t var2;
...
BME680 * BME680::instance = nullptr;
BME680 * BME680::getInstance(){
    if(instance == nullptr){
        instance = new BME680(0x76 << 1);
    }
    return instance;
